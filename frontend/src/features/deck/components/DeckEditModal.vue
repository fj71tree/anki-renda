...
const emit = defineEmits<{
  ...
  (e: 'updateDeck', id: number, name: string, memo: string): void
}>()
...
const updateDeck = () => {
  emit('updateDeck', props.editingDeck!.id, deckName.value, deckMemo.value)
}

const deckName = ref(props.editingDeck!.name)
const deckMemo = ref('')
</script>
