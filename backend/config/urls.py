...
from renda.views import CurrentUserView, CustomPasswordChangeView, DeleteAccountView, DemoLoginView, EmailChangeRequestView
...
urlpatterns = [
    ...
    path('api/auth/me/email/', EmailChangeRequestView.as_view(), name='auth_user_email_change'),
